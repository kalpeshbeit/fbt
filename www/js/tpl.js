...
function subItemRowWithRadio(subcat_id,radio_name,radio_value,label,price,ischecked)
{
    ...
    htm+='<ons-row class="row">';
     htm+='<ons-col class="concat-text" width="60%">';
       htm+='<label class="radio-button checkbox--list-item">';
	     htm+='<input type="radio" name="'+radio_name+'_'+subcat_id+'" class="'+radio_name+' sub_item_name_'+subcat_id+'" value="'+radio_value+'" '+ischecked+' data-id="'+subcat_id+'"  >';
	     htm+='<div class="radio-button__checkmark checkbox--list-item__checkmark"></div>';
	     htm+='<p class="description item-name concat-text"> '+label+'</p>';
	   htm+='</label>';
	  htm+='</ons-col>';	
    ...
    htm+='<ons-row class="row">';
     htm+='<ons-col class="concat-text" width="60%">';
       htm+='<label class="checkbox checkbox--list-item">';
	     htm+='<input type="checkbox" name="'+radio_name+'_'+subcat_id+'" class="sub_item_custom '+radio_name+' sub_item_name_'+subcat_id+' " value="'+radio_value+'" data-id="'+subcat_id+'" data-multi="'+multi_option_val+'"  >';
...
function subItemRowWithCheckboxQty(subcat_id,radio_name,radio_value,label,price)
{
    ...
    htm+='<ons-row class="row">';
     htm+='<ons-col class="concat-text" width="60%">';
       htm+='<label class="checkbox checkbox--list-item">';
	     htm+='<input type="checkbox" name="'+radio_name+'_'+subcat_id+'" class="'+radio_name+' sub_item_name_'+subcat_id+'" " value="'+radio_value+'" data-id="'+subcat_id+'" data-withqty="2" >';
	     htm+='<div class="checkbox__checkmark checkbox--list-item__checkmark"></div>';
	     htm+='<p class="description item-name concat-text"> '+label+'</p>';
	   htm+='</label>';
	  htm+='</ons-col>';	
...
function cartFooter(currency_code)
{
  var htm='';  
   ...
   htm+='<ons-row class="row cart-total-wrap my-cart-totl">';
    htm+='<ons-col  class="total qtt-text trn" width="62%"  style="padding-left:10px; padding-top: 7px;float:left;" data-trn-key="total">Quantity</ons-col>';
	
	
	
	  htm+='<ons-col class="concat-text qu-min" width="36px">';
        htm+='<button class="button button--quiet" onclick="addCartQty(1)">';
          htm+='<ons-icon class="icon-green" icon="fa-minus"></ons-icon>';
        htm+='</button>';
      htm+='</ons-col>';
	  
	     htm+='<ons-col class="qu-box" width="31px" style="margin-left: 4px;">';
      
         htm+='<ons-row class="row grey-border-bottom qu-box-bdr">';
           
		   
             htm+='<ons-col>';
             htm+='<input name="qty" type="number" style="text-align: center;" class="qty numeric_only text-input text-input--transparent" value="1">';
             htm+='</ons-col>';
      ...
      htm+='<ons-col class="concat-text qu-plus" width="36px">';
...
{	
   ...
   htm+='<ons-row >';
	   ...
	   htm+='</ons-col>';
	   htm+='<p class="description item-name concat-text bold notification grey qtyCustom">'+qty+'</p>';
...
{
   var htm='';
   htm+='<ons-row class="row-sub-item" >';
     /* htm+='<ons-col width="3%"></ons-col>';*/
	   htm+='<ons-col class="concat-text" width="60%">';
		 htm+='<input name="qty" type="number" class="subitem-qty'+x+' qty small-input text-center text-input text-input--underbar" ';
		  htm+='placeholder="qty" value="'+qty+'" data-qty="'+qty2+'" >';
